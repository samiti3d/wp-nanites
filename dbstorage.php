	...
	class WP_DB_CHAPTER_DATA extends WP_MANGA_DATABASE {
		...
		public function __construct() {
			...
			add_action( 'rest_api_init', function () {
				register_rest_route( 'manga-chapters-data/v1', 'insert/', [
					'methods' => [ 'POST'],
					'permission_callback' => '__return_true',
					'callback' => function ($data) {
						global $wpdb;
						$data_body_params = $data->get_body_params();
						$insert_results = $wpdb->insert('wp_manga_chapters_data', array(
 								'chapter_id' => '126484',
							    'storage' => 'remote',
							    'data' => str_replace(' ', '', $data_body_params['mangas']),
						));
						
						return [
							'table' => $this->table,
							'result' => 'working',
							'data' => $data_body_params['mangas'],
						];
					}
				  ]
				);
